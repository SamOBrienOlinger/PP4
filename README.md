...
## **[Testing](#testing)**
 ...
 - **Validator Testing**
   ...
   - **Lighthouse** 
    ...
    By including images of larger file sizes, specifically my own images, I received a lower Lighthouse score than I had hoped for. I followed the advice of my mentor and the Lighthouse app to convert all .jfif and .jpg images to .png format. This procedure did improve the score on both Mobile and Desktop somewhat. However, I would use smaller image sizes for future projects, and will continuing to improve current images used in this project. Certain lighthouse scores are lower than I hoped for, however this is mainly due to the large size of the hero image. I tried converting this large image from .jpeg format to .png, and then to .webp. After that I continued to try to make the hero image as small as possible, however the decrease in quality was too much. For example, below is the hero image saved as .avif.
